...
public class TransactionService {
    ...
    public String issueBook(int bookId, User user) throws Exception{
...
//            logger.error("student {} has reached maximum value of books issued", studentId);
    ...
    public String returnBook(int bookId, User user) throws Exception {
//        Book book = bookService.getBookById(bookId);
        Student studentForUser = studentService.getStudentByUser(user);

        List<Transaction> allTransactions =
            transactionRepository.getTransaction(bookId, studentForUser.getId(), TransactionType.ISSUE, TransactionStatus.SUCCESS);
